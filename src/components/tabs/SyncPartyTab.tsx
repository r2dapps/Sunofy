...
export const SyncPartyTab: React.FC<SyncPartyTabProps> = ({
  ...
  return (
    <div className="space-y-3 animate-fade pb-0 text-[var(--text-sunofy)] select-none relative flex flex-col h-[calc(100vh-100px)] sm:h-auto min-h-[580px]">
      ...
      {/* Unified Master Live Watch Party Stage Card */}
      <div className={`bg-gradient-to-b from-purple-950/80 via-[#0a0d18] to-[var(--card-sunofy)] border border-purple-500/30 rounded-3xl shadow-2xl relative overflow-hidden flex flex-col justify-between text-center transition-all duration-300 ${
        isConsoleMinimized ? 'flex-1 min-h-[340px]' : 'h-[44vh] sm:h-[50%] min-h-[240px] shrink-0'
      }`}>
        ...
        {/* Unified Integrated Room Header Bar */}
        <div className="bg-black/40 border-b border-purple-500/25 p-2.5 sm:p-3 flex items-center justify-between backdrop-blur-md shrink-0 flex-wrap gap-2 relative z-20">
          <div className="flex items-center space-x-2 min-w-0">
            <div className="w-8 h-8 rounded-xl bg-[var(--accent-sunofy)]/20 border border-[var(--accent-sunofy)]/30 flex items-center justify-center text-[var(--accent-sunofy)] shrink-0 shadow-inner">
          ...
          {/* Center Live Status & Audio Wave indicator */}
          <div className="flex items-center gap-1.5 px-2.5 py-1 bg-black/40 rounded-full border border-purple-500/30">
          ...
          <div className="flex items-center space-x-1.5 shrink-0">
            <button
              ...
              className="w-8 h-8 rounded-xl bg-white/10 hover:bg-[var(--accent-sunofy)] hover:text-black transition cursor-pointer flex items-center justify-center text-white"
            ...
            <button
              ...
              className="px-2.5 py-1.5 rounded-xl bg-red-500/20 border border-red-500/30 text-red-400 font-bold text-xs hover:bg-red-500/30 transition cursor-pointer flex items-center space-x-1"
