  ...
  return (
    <div className="space-y-3 animate-fade pb-0 text-[var(--text-sunofy)] select-none relative flex flex-col h-[calc(100vh-100px)] sm:h-auto min-h-[580px]">
      ...
      <div className={`bg-gradient-to-b from-purple-950/40 via-[#0a0d18] to-[var(--bg-sunofy)] rounded-3xl relative overflow-hidden flex flex-col justify-between text-center transition-all duration-300 ${
        ...
        <div className="bg-black/40 border-b border-purple-500/20 p-2 sm:p-2.5 flex items-center justify-between backdrop-blur-md shrink-0 flex-wrap gap-2 relative z-20 rounded-2xl">
          ...
          {/* Right Header Area: Live Status & Exit Button Stacked */}
          <div className="flex flex-col items-end gap-1.5 shrink-0">
            <div className="flex items-center space-x-1.5">
              ...
              <button
                ...
                className="w-7 h-7 rounded-xl bg-white/10 hover:bg-[var(--accent-sunofy)] hover:text-black transition cursor-pointer flex items-center justify-center text-white"
            ...
            {/* Exit Room Button Placed Below Status Badge */}
            <button
              onClick={() => {
                syncParty.leaveRoom();
                onShowToast('Exited party room. Back to solo mode.');
              }}
              className="px-2.5 py-0.5 rounded-lg bg-red-500/20 border border-red-500/30 text-red-400 font-bold text-[10px] hover:bg-red-500/30 transition cursor-pointer flex items-center space-x-1 ml-auto"
